...
#include "asmserv.c"
    ...
    //showmemsize = 1;          // Always show memory size
    ...
    farcalls = 1;             // Accept far calls, returns & addresses
    decodevxd = 1;            // Decode VxD calls (Win95/98)
    privileged = 1;           // Accept privileged commands
    iocommand = 1;            // Accept I/O commands
    badshift = 1;             // Accept shift out of range 1..31
    extraprefix = 1;          // Accept superfluous prefixes
    lockedbus = 1;            // Accept LOCK prefixes
    stackalign = 1;           // Accept unaligned stack operations
    iswindowsnt = 1;          // When checking for dangers, assume NT
