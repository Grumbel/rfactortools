...
setup(name='rfactortools',
      ...
      entry_points = {
          'gui_scripts': [
              "minised-gui = rfactortools.programs.minised-gui:main",
              "rfactortools-gui = rfactortools.programs.rfactortools-gui:main",
          ],
          'console_scripts': [
              ...
              "gtr2-to-gsc2013 = rfactortools.programs.gtr2-to-gsc2013:main",
              ...
              "race07-ids = rfactortools.programs.race07-ids:main",
              "rfactorcrypt = rfactortools.programs.rfactorcrypt:main",
              "rfactor-to-gsc2013 = rfactortools.programs.rfactor-to-gsc2013:main",
